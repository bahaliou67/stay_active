...
## Installation
Téléchargez et exécutez le fichier **[StayActiveApplication.exe](https://github.com/bahaliou67/stay_active/releases/download/windows/StayActiveApplication.exe)** pour commencer à utiliser StayActive.


## Utilisation
- Téléchargez et installez StayActive en exécutant le fichier **[StayActiveApplication.exe](https://github.com/bahaliou67/stay_active/releases/download/windows/StayActiveApplication.exe)**  pour commencer à utiliser StayActive.
